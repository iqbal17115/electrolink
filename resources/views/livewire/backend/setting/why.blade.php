...
<div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-right">
                                <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2" wire:click="whyModal"><i class="mdi mdi-plus mr-1"></i>
                                    Why</button>
                    ...
                    <div wire:ignore class="table-responsive">
                        <div wire:ignore class="table-responsive">
                            <table class="table table-bordered dt-responsive nowrap" id="whyTable" style="border-collapse: collapse; border-spacing: 0; width: 100%;"></table>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div wire:ignore.self class="modal fade" id="why" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myLargeModalLabel">Why</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form wire:submit.prevent="whySave">
...
<script>
    ...
    $(document).ready(function() {
        var datatable = $('#whyTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{route('data.why_list')}}",
            columns: [{
                    title: 'SL',
                    data: 'id'
                },
