...
<div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div wire:ignore class="table-responsive">
                        <div wire:ignore class="table-responsive">
                            <table class="table table-bordered dt-responsive nowrap" id="breakingNewsTable"
    ...
    <div wire:ignore.self class="modal fade" id="breakingNews" tabindex="-1" role="dialog"
