                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div wire:ignore class="form-group">
                                        ...
                                        <textarea class="form-control" id="long_description" rows="3" wire:model.lazy="long_description" placeholder="Long Description" rows="8">{{$long_description}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if ($product_image)
                                        <img src="{{ $product_image->temporaryUrl() }}" style="height:150px; weight:150px;" alt="Image" class="img-circle img-fluid">
                                        @endif
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div ng-repeat="file in imagefinaldata" class="img_wrp m-1">
                                        <img src="{{ $image->temporaryUrl() }}" style="height:100px; weight:100px;" alt="Image" class="img-circle img-fluid rounded mb-1 imgResponsiveMax">
